"""
Django settings for opsdriod project.
...
SECRET_KEY = '&d6w&(14zshfu7k4&_qxrqp9tms^hzfhaw&yv)kq3di%vhq^5_'
...
ROOT_URLCONF = 'opsdriod.urls'

WSGI_APPLICATION = 'opsdriod.wsgi.application'
